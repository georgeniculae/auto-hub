...
(
    ...
    working_rental_office_id BIGINT,
    CONSTRAINT pk_employee PRIMARY KEY (id)
);

ALTER TABLE public.employee
    ADD CONSTRAINT FK_EMPLOYEE_ON_WORKING_RENTAL_OFFICE
        FOREIGN KEY (working_rental_office_id)
...
INSERT INTO public.employee (first_name, last_name, job_position, working_rental_office_id)
